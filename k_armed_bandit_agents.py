...
class SampleAverageAgent(object):
    ...
    def update(self, action, reward):
        ...
        self.action_value[action] += (
            1 / self.action_count[action] * (reward - self.action_value[action])
        )

    def __repr__(self):
        return "{}(num_actions={}, e={})".format(self.__class__.__name__, self.num_actions, self.e)
...
class ConstantStepAgent(object):
    ...
    def __repr__(self):
        return "{}(num_actions={}, e={}, alpha={})".format(
            self.__class__.__name__, self.num_actions, self.e, self.alpha
        )
